...
public final class MonAnContract {
    ...
    public static final Uri URI_TABLE = Uri.parse("content://" + MenuClientContentProvider.AUTHORITY + "/" + TABLE_NAME);
    public static final Uri URI_ROW = Uri.parse("content://" + MenuClientContentProvider.AUTHORITY + "/" + TABLE_NAME + "/#");
    ...
    public static final String SQL_CREATE = "CREATE TABLE " + TABLE_NAME + "("
            ...
            + COL_DEFAULT_UNIT_ID + " INTEGER REFERENCES " + DonViTinhContract.TABLE_NAME + " ("+ DonViTinhContract.COL_SID + "),"
            + COL_CATEGORY_ID + " INTEGER REFERENCES " + DanhMucContract.TABLE_NAME + " (" + DanhMucContract.COL_SID + "),"
