...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div id="table-content">				 
		...
		<tr>
			<th class="table-header-repeat line-left"><a><%: AdminLanguageString.NumberOrdinary %></a> </th>
			<th class="table-header-repeat line-left minwidth-1"><a><%: AdminLanguageString.LanguageName %></a>	</th>
			<th class="table-header-repeat line-left minwidth-1"><a><%: AdminLanguageString.LanguageCuture %></a></th>
			<th class="table-header-repeat line-left"><a><%: AdminLanguageString.Option %></a></th>
		</tr>
        <% int iCount = 0; %>       
