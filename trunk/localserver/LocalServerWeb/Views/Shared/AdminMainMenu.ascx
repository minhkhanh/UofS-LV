...
<!--  start nav -->
		...
		<ul <%: ((int)ViewData["menuMainId"] == 1)?"class=current":"class=select" %> ><li><a href="#nogo"><b>Products</b></a>
		<div class='select_sub <%: ((int)ViewData["menuMainId"] == 1)?"show":"" %> '>
			<ul class="sub">
				<li <%: ((int)ViewData["menuSubId"] == 0 && (int)ViewData["menuMainId"] == 1)?"class=sub_show":"" %> ><a href="#nogo">View all products</a></li>
