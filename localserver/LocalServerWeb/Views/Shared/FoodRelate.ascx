    ...
    <% if (Model.Count > 0)
       {
        %>
        <div id="slider">
            <img class="scrollButtons left" src="../../Images/foodcategory/foodrelate/leftarrow.png" alt="scroll_button_left" />
            ...
            <img class="scrollButtons right" src="../../Images/foodcategory/foodrelate/rightarrow.png" alt="scroll_button_right" />
        </div>
        <%            
