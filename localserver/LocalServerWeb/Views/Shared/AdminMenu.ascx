...
<div id="nav-menu">
    ...
    <ul id="css3menu1" class="topmenu">
        ...
        <li class="topmenu"><a href="" style="height: 32px; line-height: 32px;"><span>
            <img src="<%: Url.Content("~/Content/css3menu/user.png") %>" alt="Area" /><%: MenuString.User %></span></a>
            <ul>
                <li class="subfirst"><a href="<%: Url.Action("Index", "AdminUser") %>"><span>
                    <img src="<%: Url.Content("~/Content/css3menu/1.png") %>" alt="Area manager" /><%: MenuString.ManageUser %></span></a>
                    <ul>
                        <li class="sublast"><a href="<%: Url.Action("Add", "AdminUser") %>">
                            <img src="<%: Url.Content("~/Content/css3menu/adduser.png") %>" alt="Add area" /><%: MenuString.AddUser %></a></li>
                    </ul>
                </li>
            </ul>
        </li>
        ...
        <li class="topmenu"><a href="<%= Url.Action("Index", "AdminConfig") %>" style="height: 32px;
            line-height: 32px;">
            <img src="<%: Url.Content("~/Content/css3menu/config.png") %>" alt="Config" /><%:MenuString.Config %></a></li>
        <!-- Account ------------------------------------------------------------------------------------------------------------->
